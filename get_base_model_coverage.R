...
for (i in 1:100) {
  ...
  bias_m[i,] <- all_draws_post_prop[1,] - colMeans(inv.logit(posterior_linpred(new_stan_results)))  
...
#save(new_stan_results, coverage_m, prop_coverage_m, prop_coverage_length_m, adj_prop_coverage_m, adj_prop_coverage_length_m, bias_m, zip_coverage_m, zip_coverage_length_m, adj_zip_coverage_m, adj_zip_coverage_length_m, file = "test.Rdata")
