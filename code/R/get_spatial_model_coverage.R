...
for (i in 1:100) {
  ...
  prop_coverage_length_m[i,] <- prop_coverage_info[[2]]
    ...
    post_draws_get_prop_coverage_adjusted_multiple(draws_df, all_draws_post_prop[1,], sim_reduced_covid_data)
...
save(coverage_m, prop_coverage_m,
     prop_coverage_length_m,
